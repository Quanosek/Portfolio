      ...
      <div className={styles.about}>
        <div className={`${styles.websites} reveal`}>
          <div className={styles.text}>
            ...
            <p>
              ...
              wykorzystanie <u>frameworku</u>. Początkowo <b>Vue</b>,
              a&nbsp;teraz <b>React</b>, dają ogromne możliwości i&nbsp;dzięki
              tym narzędziom mogę w&nbsp;pełni <b>uwolnić swoją wyobraźnię</b>.
              Z&nbsp;pomocą <b>TypeScript</b> oraz <b>Sass</b> jestem
              w&nbsp;stanie stworzyć <u>dowolny design</u>.
            </p>
          </div>
        ...
        <div className={`${styles.apps} reveal`}>
          ...
          <div className={styles.text}>
            ...
            <p>
              Tworzę również aplikacje lub skrypty w&nbsp;językach:{" "}
              <b>Python</b>, <b>JavaScript</b> czy nawet <b>bash</b>! Najlepszą
              możliwością na kreatywne wykorzystanie dostępnych możliwości daje
              mi <u>programowanie botów</u> na różne serwery <b>Discord</b>,
